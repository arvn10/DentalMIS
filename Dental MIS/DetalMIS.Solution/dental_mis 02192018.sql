...
INSERT INTO `audit_trail` VALUES (1,'User Create User ID 1','Admin','2018-02-19 02:48:39'),(2,'User Edit User ID 1','Admin','2018-02-19 02:56:21'),(3,'User Create User ID 2','Admin User','2018-02-19 03:07:41'),(4,'User Edit User ID 2','Admin User','2018-02-19 03:08:27'),(5,'User Edit User ID 2','Admin User','2018-02-19 03:08:37');
...
INSERT INTO `user` VALUES (1,1,1,'admin','password','red','Admin','User',1,'Admin',NULL,NULL,NULL),(2,2,1,'secretary','password','black','Secretary','Account',1,'Admin User','2018-02-19 03:07:41','','2018-02-19 03:08:37');
...
BEGIN
    ...
    WHERE `pt`.`status` = true AND 
		  `ptn`.`procedure_type_id` = `@procedure_id`;
...
-- Dump completed on 2018-02-19  4:18:55
