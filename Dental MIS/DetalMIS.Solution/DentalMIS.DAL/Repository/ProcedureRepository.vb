Public Class ProcedureRepository
    ...
    Public Function ProcedureCreate(param As ProcedureCreate) As Long
    ...
    Public Function ProcedureEdit(param As ProcedureEdit) As Long
    ...
    Public Function ProcedureSearchID(id As Long) As List(Of ProcedureView)
        ...
        Dim data As New List(Of ProcedureView)
    ...
    Public Function ProcedureSearchLike(searchText As Long) As List(Of ProcedureView)
        Dim procedure As String = String.Format("CALL `dental_mis`.`usp_procedure_search_id`('{0}');",
                                                searchText)
        Dim dt As DataTable = ExecuteDataset(procedure)
        Dim data As New List(Of ProcedureView)
