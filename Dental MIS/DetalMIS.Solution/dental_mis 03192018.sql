...
INSERT INTO `patient` VALUES (2,'Test','Qwea','test test','123','asdasd','qweqweq','2013-03-17',5,'Male','Qwe','0922222221','Maried','1','2018-02-22 01:13:54','1','2018-03-18 00:28:13'),(3,'Qweqwe','Qweqwe','Qwe Qwe','123123','Qweqwe','Qweqwe','1994-03-17',24,'Male','qweqweqwe','','','1','2018-03-17 17:15:55',NULL,NULL),(4,'Qweqwe','Qweqwe','Qqq Q','123123','123123Qweqwe','Qweqweq123123','2014-02-13',4,'Male','13123123qweqwe','1321313','Single','1','2018-03-18 00:48:36',NULL,NULL),(5,'Test','Qwea','Test Test','123','Asdasd','Qweqweq','2013-03-18',4,'Male','Qwe','0922222221','Maried','1','2018-03-18 01:36:34',NULL,NULL);
...
/*!50001 CREATE VIEW `patient_view` AS SELECT 
 ...
 1 AS `middle_name`,
 1 AS `full_name`,
 1 AS `address_house_number`,
 1 AS `address_street_building`,
...
INSERT INTO `payment` VALUES (1,1,600,'2018-03-13','1','2018-03-13 18:56:20',NULL,NULL),(2,2,500,'2018-03-18','1','2018-03-18 04:22:34',NULL,NULL),(3,3,900,'2018-03-19','1','2018-03-19 02:01:05','1','2018-03-19 02:47:56'),(5,3,99,'2018-03-19','1','2018-03-19 02:04:32',NULL,NULL),(6,3,1,'2018-03-19','1','2018-03-19 02:04:41',NULL,NULL);
...
INSERT INTO `procedure` VALUES (1,2,6,2,600,'qwe','2018-03-07','1','2018-03-07 22:47:24',NULL,NULL),(2,2,7,2,500,'qwe','2018-03-18','1','2018-03-18 00:54:58',NULL,NULL),(3,2,8,3,1000,'','2018-02-18','1','2018-03-18 04:30:12','1','2018-03-19 11:10:07'),(4,2,6,NULL,600,NULL,'2018-03-19','1','2018-03-19 11:13:04',NULL,NULL);
/*!40000 ALTER TABLE `procedure` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `procedure_remark`
--

DROP TABLE IF EXISTS `procedure_remark`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `procedure_remark` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `procedure_remark` WRITE;
/*!40000 ALTER TABLE `procedure_remark` DISABLE KEYS */;
INSERT INTO `procedure_remark` VALUES (1,3,'qweqwe','2018-03-19','1','2018-03-19 05:06:00','1','2018-03-19 11:10:07'),(2,3,'qwea','2018-03-19','1','2018-03-19 05:09:49','1','2018-03-19 11:10:07');
...
INSERT INTO `procedure_tooth` VALUES (1,1,1,'1','2018-03-18 18:48:21',NULL,NULL),(2,1,2,'1','2018-03-18 18:48:22',NULL,NULL),(3,3,2,'1','2018-03-19 09:54:34','1','2018-03-19 11:10:11'),(4,3,3,'1','2018-03-19 09:54:34','1','2018-03-19 11:10:11'),(5,4,1,'1','2018-03-19 11:13:04',NULL,NULL);
...
INSERT INTO `procedure_type` VALUES (6,'Extraction',600,'Installment',1,'Yes',1,'1','2018-02-22 01:17:16','1','2018-03-18 18:50:28'),(7,'qwe',500,'Installment',1,'Optional',1,'1','2018-02-22 22:59:53',NULL,NULL),(8,'Testq',1000,'Installment',0,'Yes',1,'1','2018-03-18 03:07:29',NULL,NULL),(9,'test',500,'Full Payment',1,'Yes',0,'1','2018-03-19 11:15:10','1','2018-03-19 11:15:20');
/*!40000 ALTER TABLE `procedure_type` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `procedure_type_pair`
--

DROP TABLE IF EXISTS `procedure_type_pair`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `procedure_type_pair` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `procedure_type_pair` WRITE;
/*!40000 ALTER TABLE `procedure_type_pair` DISABLE KEYS */;
INSERT INTO `procedure_type_pair` VALUES (2,6,6,'Hide',1,'1','2018-02-22 01:17:59','1','2018-03-18 18:51:11'),(3,6,7,'Show',1,'1','2018-03-18 12:38:19','1','2018-03-18 18:50:56'),(4,6,8,'Show',1,'1','2018-03-18 12:42:56','1','2018-03-18 18:51:02');
...
INSERT INTO `secret_question` VALUES (1,'What is your favorite color?','1','2018-02-19 02:56:07',NULL,NULL),(2,'What was your childhood nickname?','1','2018-02-19 02:56:07',NULL,NULL),(3,'In what city did you meet your spouse/significant other?','1','2018-02-19 02:56:07',NULL,NULL),(4,'What is the name of your favorite childhood friend?','1','2018-02-19 02:56:07',NULL,NULL),(5,'What street did you live on in third grade?','1','2018-02-19 02:56:07',NULL,NULL),(6,'What is your oldest sibling’s birthday month and year? (e.g., January 1900)','1','2018-02-19 02:56:07',NULL,NULL),(7,'What school did you attend for sixth grade?','1','2018-02-19 02:56:07',NULL,NULL),(8,'What is your oldest cousin\'s first and last name?','1','2018-02-19 02:56:07',NULL,NULL),(9,'In what city or town did your mother and father meet?','1','2018-02-19 02:56:07',NULL,NULL),(10,'What is the first name of the boy or girl that you first kissed?','1','2018-02-19 02:56:07',NULL,NULL),(11,'What is your oldest brother’s birthday month and year? (e.g., January 1900)','1','2018-02-19 02:56:07',NULL,NULL),(12,'What is your maternal grandmother\'s maiden name?','1','2018-02-19 02:56:07',NULL,NULL),(13,'In what city or town was your first job?','1','2018-02-19 02:56:07',NULL,NULL),(14,'What is the name of the place your wedding reception was held?','1','2018-02-19 02:56:07',NULL,NULL),(15,'What is the name of a college you applied to but didn\'t attend?','1','2018-02-19 02:56:07',NULL,NULL);
...
INSERT INTO `tooth` VALUES (1,'(UR) Third Molar','admin','2018-02-02 00:43:00',NULL,NULL),(2,'(UR) Second Molar','admin','2018-02-02 00:43:00',NULL,NULL),(3,'(UR) First Molar','admin','2018-02-02 00:43:00',NULL,NULL),(4,'(UR) Second Bicuspid','admin','2018-02-02 00:43:00',NULL,NULL),(5,'(UR) First Bicuspid','admin','2018-02-02 00:43:00',NULL,NULL),(6,'(UR) Bicuspid','admin','2018-02-02 00:43:00',NULL,NULL),(7,'(UR) Lateral Incisor','admin','2018-02-02 00:43:00',NULL,NULL),(8,'(UR) Central Incisor','admin','2018-02-02 00:43:00',NULL,NULL),(9,'(UL) Central Incisor','admin','2018-02-02 00:43:00',NULL,NULL),(10,'(UL) Lateral Incisor','admin','2018-02-02 00:43:00',NULL,NULL),(11,'(UL) Bicuspid','admin','2018-02-02 00:43:00',NULL,NULL),(12,'(UL) First Bicuspid','admin','2018-02-02 00:43:00',NULL,NULL),(13,'(UL) Second Bicuspid','admin','2018-02-02 00:43:00',NULL,NULL),(14,'(UL) First Molar','admin','2018-02-02 00:43:00',NULL,NULL),(15,'(UL) Second Molar','admin','2018-02-02 00:43:00',NULL,NULL),(16,'(UL) Third Molar','admin','2018-02-02 00:43:00',NULL,NULL),(17,'(LL) Third Molar','admin','2018-02-02 00:43:00',NULL,NULL),(18,'(LL) Second Molar','admin','2018-02-02 00:43:00',NULL,NULL),(19,'(LL) First Molar','admin','2018-02-02 00:43:00',NULL,NULL),(20,'(LL) Second Bicuspid','admin','2018-02-02 00:43:00',NULL,NULL),(21,'(LL) First Bicuspid','admin','2018-02-02 00:43:00',NULL,NULL),(22,'(L) Bicuspid','admin','2018-02-02 00:43:00',NULL,NULL),(23,'(LL) Lateral Incisor','admin','2018-02-02 00:43:00',NULL,NULL),(24,'(LL) Central Incisor','admin','2018-02-02 00:43:00',NULL,NULL),(25,'(LR) Central Incisor','admin','2018-02-02 00:43:00',NULL,NULL),(26,'(LR) Lateral Incisor','admin','2018-02-02 00:43:00',NULL,NULL),(27,'(LR) Bicuspid','admin','2018-02-02 00:43:00',NULL,NULL),(28,'(LR) First Bicuspid','admin','2018-02-02 00:43:00',NULL,NULL),(29,'(LR) Second Bicuspid','admin','2018-02-02 00:43:00',NULL,NULL),(30,'(LR) First Molar','admin','2018-02-02 00:43:00',NULL,NULL),(31,'(LR) Second Molar','admin','2018-02-02 00:43:00',NULL,NULL),(32,'(LR) Third Molar','admin','2018-02-02 00:43:00',NULL,NULL),(33,'All Tooths','admin','2018-02-02 00:43:00',NULL,NULL),(34,'All Upper Tooths','admin','2018-02-02 00:43:00',NULL,NULL),(35,'All Lower Tooths','admin','2018-02-02 00:43:00',NULL,NULL);
...
INSERT INTO `user` VALUES (1,1,1,'admin','password','red','Admin','User',1,'1',NULL,'Admin User','2018-03-18 02:59:03'),(2,2,1,'secretary','password','blackq','Secretary','Account',1,'1','2018-02-19 03:07:41','Admin User','2018-02-19 05:55:41');
...
--
/*!50003 DROP FUNCTION IF EXISTS `acronym` */;
...
/*!50003 DROP FUNCTION IF EXISTS `initials` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `usp_patient_search_report` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `usp_patient_search_report`(IN 
    `@from` NVARCHAR(20),
    `@to` NVARCHAR(20)
)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `usp_procedure_remark_create` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `usp_procedure_remark_create`(in
`@procedure_id` BIGINT,
`@value` TEXT,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `usp_procedure_remark_edit` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `usp_procedure_remark_edit`(in
	`@id` BIGINT,
	`@value` TEXT,
	`@date_added` varchar(45),
	`@updated_by` varchar(45)
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `usp_procedure_remark_select_id` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `usp_procedure_remark_select_id`(in
	`@id` BIGINT
)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `usp_procedure_remark_select_procedure_id` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `usp_procedure_remark_select_procedure_id`(in
	`@procedure_id` BIGINT
)
BEGIN
	SELECT * FROM `dental_mis`.`procedure_remark`
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `usp_procedure_tooth_select_id` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `usp_procedure_tooth_select_id`(IN
	`@id` BIGINT
)
BEGIN
	SELECT 
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `usp_procedure_tooth_select_procedure_id` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `usp_procedure_tooth_select_procedure_id`(IN
	`@procedure_id` BIGINT
)
BEGIN
	SELECT 
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `usp_procedure_type_pair_create` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `usp_procedure_type_pair_create`(IN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `usp_procedure_type_pair_edit` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `usp_procedure_type_pair_edit`(IN
	`@id` BIGINT,
	`@procedure_type_id` BIGINT,
    `@procedure_type_id_pair` BIGINT,
    `@visibility_type` varchar(254),
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `usp_procedure_type_pair_select` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `usp_procedure_type_pair_select`(IN
	`@procedure_id` BIGINT 
)
BEGIN
	SELECT
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `usp_procedure_type_pair_select_id` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `usp_procedure_type_pair_select_id`(IN
	`@id` BIGINT 
)
BEGIN
	SELECT
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `usp_procedure_type_search` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `usp_procedure_type_search`(
)
BEGIN
...
-- Dump completed on 2018-03-19 11:20:43
